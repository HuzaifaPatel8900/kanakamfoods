  ...
  return (
    ...
    <div className='p-4 flex justify-between items-center container mx-auto'>
        ...
        <div className='flex items-center gap-4'>
            ...
            <div className='flex bg-[#55240A] cursor-pointer text-white p-4 gap-2 items-center rounded-xl'><img className='size-6' src="/img/Vector (1).svg" alt="" /><span className='font-semibold'>CART <span className='bg-[#DC2626] py-1 px-2 rounded-full'>{itemCount}</span></span><span className='font-semibold'>{formattedTotal}</span></div>
        </div>
    </div>
    </div>
